          ...
          <div className="flex flex-1 justify-end gap-4 sm:gap-8">
            ...
            <div className="flex gap-2">
              ...
              <Link href="/sign-in" passHref>
                <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-[#283139] text-white text-sm font-bold leading-normal tracking-[0.015em]">
            ...
            <div className="w-full">
              <div className="p-4">
                ...
                >
                  ...
                  <Link href="/sign-up" passHref>
                    <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 md:h-12 md:px-5 bg-[#1383eb] text-white text-sm font-bold leading-normal tracking-[0.015em] md:text-base md:font-bold md:leading-normal md:tracking-[0.015em]">
              ...
              <div className="flex flex-col justify-end gap-6 px-4 py-10 md:gap-8 md:px-10 md:py-20">
                ...
                <div className="flex flex-1 justify-center">
                  <div className="flex justify-center">
                    <Link href="/sign-up" passHref>
                      <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 md:h-12 md:px-5 bg-[#1383eb] text-white text-sm font-bold leading-normal tracking-[0.015em] md:text-base md:font-bold md:leading-normal md:tracking-[0.015em] grow">
                        <span className="truncate">Get started for free</span>
                      </button>
                    </Link>
                  </div>
          ...
          <div className="flex max-w-[960px] flex-1 flex-col">
            <footer className="flex flex-col gap-6 px-5 py-10 text-center">
              <div className="flex flex-wrap items-center justify-center gap-6 md:flex-row md:justify-around">
                <a
                  className="text-[#9dabb9] text-base font-normal leading-normal min-w-40"
                  href="#"
                >
                  Terms of Service
                </a>
