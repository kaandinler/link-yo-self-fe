...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-page via-page-accent to-page">
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-line rounded-2xl p-8 shadow-2xl">
              <div className="bg-surface-raised rounded-xl p-6 space-y-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="h-3 bg-field-strong rounded w-24 mb-1"></div>
                    <div className="h-2 bg-field rounded w-16"></div>
                  </div>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="bg-pink-600 h-12 rounded-lg flex items-center justify-center">
                    <span className="text-ink font-medium">Twitter</span>
                  </div>
                  <div className="bg-blue-600 h-12 rounded-lg flex items-center justify-center">
                    <span className="text-ink font-medium">LinkedIn</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="features" className="relative px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group bg-surface/50 backdrop-blur-sm border border-line rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <LinkIcon className="h-8 w-8 text-ink" />
              </div>
            ...
            <div className="group bg-surface/50 backdrop-blur-sm border border-line rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-ink mb-4">Custom Design</h3>
              <p className="text-ink-soft leading-relaxed">
            ...
            <div className="group bg-surface/50 backdrop-blur-sm border border-line rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-ink mb-4">Analytics</h3>
              <p className="text-ink-soft leading-relaxed">
            ...
            <div className="group bg-surface/50 backdrop-blur-sm border border-line rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-ink mb-4">Easy Setup</h3>
              <p className="text-ink-soft leading-relaxed">
            ...
            <div className="group bg-surface/50 backdrop-blur-sm border border-line rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-ink mb-4">SEO Friendly</h3>
              <p className="text-ink-soft leading-relaxed">
      ...
      {/* Footer */}
      <footer className="relative px-4 sm:px-6 lg:px-8 py-12 border-t border-line">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-ink">LinkYoSelf</span>
            </div>
