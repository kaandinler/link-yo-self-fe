...
import { Star, Users, Target, Heart, CheckCircle, ArrowRight } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              We're on a mission to simplify how creators, influencers, and professionals 
              share their digital presence with the world.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                We believe that sharing your digital presence shouldn't be complicated. 
                That's why we created LinkYoSelf - to give you one powerful link that 
                connects your audience to everything you create and share online.
              </p>
              
              <p className="text-lg text-gray-300 leading-relaxed">
                Our platform empowers creators, influencers, artists, entrepreneurs, 
                and professionals to build their personal brand and share all their 
                important content through one beautiful, customizable page.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Customizable Link Pages</h3>
              <p className="text-gray-300 leading-relaxed">
                Create beautiful, personalized pages that reflect your brand and style. 
            ...
            <div className="group bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-300 leading-relaxed">
                Track your performance with detailed analytics. Understand your audience 
            ...
            <div className="group bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Mobile-Optimized Designs</h3>
              <p className="text-gray-300 leading-relaxed">
                Your pages look perfect on all devices. Mobile-first design ensures 
            ...
            <div className="group bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Easy Content Management</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="group bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-300 leading-relaxed">
                Our dedicated support team is here to help you succeed. Get assistance 
            ...
            <div className="group bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <p className="text-gray-300 leading-relaxed">
                Built-in SEO features help your page rank better in search results 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="inline-flex items-center gap-2 bg-green-500/20 backdrop-blur-sm border border-green-500/30 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm text-green-300">Why Choose LinkYoSelf</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                ...
                sacrificing functionality. We provide powerful tools that are easy 
                to use, helping you build meaningful connections with your audience.
              </p>
              
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Join thousands of successful creators who have chosen LinkYoSelf 
                to represent their digital identity and grow their online presence.
              </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-gray-700 rounded-3xl p-12 shadow-2xl">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join our community of creators and start sharing your world with one beautiful link.
            </p>
