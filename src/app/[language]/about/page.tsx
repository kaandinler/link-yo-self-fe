            ...
            <div className="flex flex-col gap-10 px-4 py-10 md:py-16">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-white text-base font-normal leading-normal max-w-[720px]">
                  LinkYoSelf is the ultimate solution for creators, influencers,
                  and professionals who want to share all their important
                  content through one simple link.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-3 rounded-lg border border-[#3b4854] bg-[#1c2127] p-6">
                  ...
                  <p className="text-[#9dabb9] text-base font-normal leading-normal">
                    ...
                    complicated. That's why we created LinkYoSelf - to give you
                    one powerful link that connects your audience to everything
                ...
                <div className="flex flex-col gap-3 rounded-lg border border-[#3b4854] bg-[#1c2127] p-6">
                  ...
                  <p className="text-[#9dabb9] text-base font-normal leading-normal">
                    Unlike other platforms, LinkYoSelf focuses on simplicity
                    without sacrificing functionality. We provide powerful tools
                    that are easy to use, helping you build meaningful
