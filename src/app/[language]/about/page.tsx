        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <div className="inline-flex items-center gap-2 bg-surface/50 backdrop-blur-sm border border-line rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-sm text-ink-soft">Our Story</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-line rounded-2xl p-8 shadow-2xl">
                <div className="bg-surface-raised rounded-xl p-6 space-y-6">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
                      <Users className="h-6 w-6 text-ink" />
                    </div>
                    <div>
                      <div className="text-ink font-semibold">10,000+</div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-ink font-semibold">1M+</div>
                      <div className="text-ink-muted text-sm">Links Shared</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-ink font-semibold">99%</div>
