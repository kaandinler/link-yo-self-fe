...
const Dashboard = () => {
  ...
  const recentLinks = [
    { id: 1, title: 'Instagram Profile', url: 'instagram.com/johndoe', clicks: 324, isActive: true },
    { id: 2, title: 'Twitter Account', url: 'twitter.com/johndoe', clicks: 256, isActive: true },
    { id: 3, title: 'Personal Website', url: 'johndoe.dev', clicks: 189, isActive: true },
    { id: 4, title: 'YouTube Channel', url: 'youtube.com/@johndoe', clicks: 167, isActive: false },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-4 md:p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Your Profile URL</h3>
          ...
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white">{user.totalLinks}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm border border-green-500/30 rounded-2xl p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white">{user.profileViews}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            {recentLinks.map((link) => (
              <div key={link.id} className="flex items-center justify-between p-4 bg-gray-700/30 hover:bg-gray-700/50 rounded-xl transition-colors">
                <div className="flex items-center gap-3">
                  <div className={`w-3 h-3 rounded-full ${link.isActive ? 'bg-green-400' : 'bg-gray-500'}`}></div>
                  <div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-gray-700/30 rounded-lg">
              ...
              <div>
                <p className="text-white text-sm">Your Instagram link got 25 new clicks</p>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-700/30 rounded-lg">
              ...
              <div>
                <p className="text-white text-sm">12 people viewed your profile</p>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-700/30 rounded-lg">
              ...
              <div>
                <p className="text-white text-sm">You added a new link: "Portfolio Website"</p>
